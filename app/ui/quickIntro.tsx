              ...
              <List className="">
                ...
                <List.Item className="mt-6"> <span className="text-purple-500 dark:text-cyan-400  font-bold">Chuyên gia solo </span> hưởng doanh thu khi có nhà đầu tư mua các gói theo dõi mình (trọn đời hoặc theo tháng )
                  ...
                  <List  className="mb-6" ordered nested>
                    ...
                    <List.Item > VD chuyên gia ra giá gói theo tháng là 4 triệu và thu hút được 50 người theo dõi thì mỗi tháng chuyên gia sẽ hưởng 160 triệu / tháng   </List.Item>
                  </List>
                ...
                <List.Item className=""> <span className="text-purple-500 dark:text-cyan-400  font-bold">Người giới thiệu</span> nhận được thu nhập mỗi khi người được giới thiệu có các hoạt động dưới đây
...
{/* 
                ...
                <List.Item>Có thể giới thiệu và hưởng doanh thu không giới hạn số người, chỉ bằng cách gửi link website liên kết với tài khoản được tạo  <Link href="/profile"> ở đây</Link>   </List.Item>
              </List>
            </>)
          }
        </div>
