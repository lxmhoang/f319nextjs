  ...
  return (
    ...
    {/* <Accordion>
     ...
     ffff
      ...
      <Accordion>
      {expert.articles?.map ( (item , index) => {
        console.log("aaaaa" + item.stockCode)
        console.log("ooooo" + item.cutLossPrice)
        return ( <AccordionItem key= {"c_" + index}  aria-label={item.cutLossPrice?.toString() } subtitle="Press to expand" title={item.cutLossPrice?.toString() }>{item.stockCode}</AccordionItem> )
      }
    ...
    return (
      ...
      {params.id}Get started by edddditing&nbsp;
